...
const home: Home = {
  ...
  label: "Home",
  title: 'The Bachata App',
  description: `Your one-stop shop for bachata privates, events, and more.`,
  headline: <>Your one-stop shop for bachata privates, events, and more.</>,
  featured: {
    display: true,
    title: (
